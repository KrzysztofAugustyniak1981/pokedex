...
const EditPokemonForm = () => {
        ...
        const loadData = async () => {
            ...
            if (apiPokemon) {
                ...
                setFormData({
                    ...
                    base_experience: customVersion?.base_experience || apiPokemon.base_experience,
                });
            } else {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (customRecordId) {
                const customPokemons = await getCustomPokemons();
                const oldRecord = customPokemons.find((custom) => custom.id === customRecordId);
            ...
            console.error("Błąd edit Pokémona:", error);
        }
    };
